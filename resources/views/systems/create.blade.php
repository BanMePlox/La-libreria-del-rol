...
<img src="{{asset('storage/accesodenegado.png')}}" alt="Goblin asustado" class="rounded mx-auto d-block" height="400px">
<h1 class="text-warning text-center m-5">Vaya, aventurero, parece que estás un poco perdido! Quizá quieres volver al inicio?</h1></a>
@stop
@endif
